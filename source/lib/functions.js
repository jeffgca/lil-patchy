...
// export async function captureTabImage(tabId) {
//   console.log('captureTabImage');
//   return browser.tabs.captureVisibleTab(tabId);
// }

// export async function handlePageData(data) {
...
// export async function runAction(tabId) {
...
//   console.log('getCurrentActiveTab', result);
