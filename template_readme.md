...
> This project was created from a [template](https://github.com/fregante/browser-extension-template) - this is the original readme file that contains some useful information about how to use some of the utilities provided.
